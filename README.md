...
The quality path continues while potential GS is at least 58. Independently, a
piece is kept when four of its five enhancement rolls land on Speed. If neither
outcome remains possible, the piece is rejected. A missing packet is retried at
the same target after a two-second wait instead of guessing from the screen.
